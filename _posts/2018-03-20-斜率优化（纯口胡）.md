...
<a href="https://www.codecogs.com/eqnedit.php?latex=f[i]=min(f[j]&plus;sum[i]-sum[j]&plus;i-j-1-L)(0<=j<i)" target="_blank"><img src="https://latex.codecogs.com/gif.latex?f[i]=min(f[j]&plus;sum[i]-sum[j]&plus;i-j-1-L)(0<=j<i)" title="f[i]=min(f[j]+sum[i]-sum[j]+i-j-1-L)(0<=j<i)" /></a>
